                  ...
                  if(res["step6"]!=""){
                    ...
                    if(res["step7"]!=""){
                          ...
                          if(res["step10"]!=""){
                            ...
                            $div.bind("touchstart",function(event){
                              ...
                              $(document).bind("touchmove",function(event){
                                ...
                                var bw = $("#box").width();
                                if(stop_x>0){
                                    $("#slide").animate({left:"0px"},10);
                                  return;
                                }else if(stop_x<-(sw-bw)+5){
                                    $("#slide").animate({left:-(sw-bw)+5+"px"},10);
                                  return;
                                }else{
                                  $("#slide").animate({left:stop_x},10);
                                  return;
                                }
                              });
                            });
                      ...
                      <body>
                        ...
                        <div id="top_info" style="height:25px;background-color:green;"></div>
                        <button style="margin-top: 50px;width: 100%;height: 50px;">风险保障转款 ￥12795.13</button>
                        <div id="step_box"></div>
                      </body>
                      </html>
