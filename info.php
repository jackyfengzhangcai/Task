	...
	<div id="step_box">
		<div style="display: flex;margin:20px 20px 20px 20px;">
			...
			<span id="box" style="overflow: hidden;position: relative;width:calc(100% - 60px);margin:0px 0px 0px 20px;">
				<div id="slide" style="position:relative;display:inline-block;width: 1000px;height: 70px;">
					<img style="width: 70px;height: 70px;" src="4.png">
					<img style="width: 70px;height: 70px;" src="3.png">
					<img style="width: 70px;height: 70px;" src="2.png">
					<img style="width: 70px;height: 70px;" src="1.png">
					<img style="width: 70px;height: 70px;" src="5.png">
					<img style="width: 70px;height: 70px;" src="6.png">
				</div>
